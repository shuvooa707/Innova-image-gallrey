...
export default function Post(props) {
	...
	console.log(content, medias, totallikes, user, comments)
	return (
		<>
			<div className="post">
				...
				<div className="image-container">
					{
						medias.map((media, i) => {
							return <img className="post-image" src={"/img/post/" + media.path} key={i}/>
						})
					}
				</div>
				<div className="like-container">
					<span className="like-button">
						<svg style={{width: "20px", height: "20px"}} fill="#000000" height="800px" width="800px" version="1.1" id="Capa_1"
